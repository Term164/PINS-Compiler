...
public class SynAn implements AutoCloseable {
	...
	private AstExpr parseFuncall(){
		...
		switch (peek()){
			...
			case ASSIGN,SEMICOLON,COLON,RB,COMMA,LSB,RSB,EXP,WHERE,OR,AND,EQUAL,NOTEQUAL,LESS,GREATER,LESSEQUAL,GREATEREQUAL,PLUS,MINUS,MUL,DIV,MOD,THEN,DO -> {return new AstNameExpr(location, name);}
