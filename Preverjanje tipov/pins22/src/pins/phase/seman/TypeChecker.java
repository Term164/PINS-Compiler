...
public class TypeChecker extends AstFullVisitor<Object, Boolean> {
    ...
    public Object visit(AstFunDecl funDecl, Boolean aBoolean) {
        ...
        SemType actualType = (SemType) funDecl.pars.accept(this, aBoolean);
        if (returnType.actualType().getClass() != actualType.actualType().getClass()) throw new Report.Error(funDecl.location, "Semantic error: return type does not match expected return type.");
        funDecl.expr.accept(this, aBoolean);
        return  returnType;
    }
    ...
    public Object visit(AstBinExpr binExpr, Boolean aBoolean) {
        ...
        if (binExpr.oper.equals(AstBinExpr.Oper.ARR)){
            SemAn.exprOfType.put(binExpr, ((SemArr)leftOperand).elemType);
            return ((SemArr)leftOperand).elemType;
        }else {
    ...
    public Object visit(AstCastExpr castExpr, Boolean aBoolean) {
        ...
        if ((type.actualType() instanceof SemChar || type.actualType() instanceof SemInt || type.actualType() instanceof SemPtr) &&
            ...
            SemAn.exprOfType.put(castExpr,  type);
            return type;
